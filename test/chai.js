(function (f) { if (typeof exports === 'object' && typeof module !== 'undefined') { module.exports = f(); } else if (typeof define === 'function' && define.amd) { define([], f); } else { let g; if (typeof window !== 'undefined') { g = window; } else if (typeof global !== 'undefined') { g = global; } else if (typeof self !== 'undefined') { g = self; } else { g = this; }g.chai = f(); } }(() => {
   ...
   */
      ...
      './chai/assertion': 3, './chai/config': 4, './chai/core/assertions': 5, './chai/interface/assert': 6, './chai/interface/expect': 7, './chai/interface/should': 8, './chai/utils': 22, 'assertion-error': 33,
    }],
   ...
   */
     ...
     */
        ...
        ['to', 'be', 'been', 'is',
          'and', 'has', 'have', 'with',
          'that', 'which', 'at', 'of',
          'same', 'but', 'does', 'still'].forEach((chain) => {
     ...
     */
        ...
        function include(val, msg) {
          ...
          switch (objType) {
            ...
            case 'array':
              if (isDeep) {
                included = obj.some((item) => _.eql(item, val));
              } else {
                included = obj.indexOf(val) !== -1;
              }
              break;
     ...
     */
        ...
        function assertKeys(keys) {
          ...
          if (objType === 'Map' || objType === 'Set') {
            ...
            obj.forEach((val, key) => { actual.push(key); });
          ...
          // Key string
          if (len > 1) {
            keys = keys.map((key) => _.inspect(key));
            const last = keys.pop();
            if (all) {
     ...
     */
        ...
        function respondTo(method, msg) {
          ...
          const context = (typeof obj === 'function' && !itself)
   ...
   */
     ...
     */
        ...
        const assert = chai.assert = function (express, errmsg) {
          const test = new Assertion(null, null, chai.assert, true);
          test.assert(
            express,
            errmsg,
     ...
     */
        ...
        assert.equal = function (act, exp, msg) {
          const test = new Assertion(act, msg, assert.equal, true);
     ...
     */
        ...
        assert.throws = function (fn, errorLike, errMsgMatcher, msg) {
          ...
          const assertErr = new Assertion(fn, msg, assert.throws, true)
     ...
     */
        ...
        assert.operator = function (val, operator, val2, msg) {
          ...
          const test = new Assertion(ok, msg, assert.operator, true);
          test.assert(
   ...
   */
      ...
      const excludeNames = Object.getOwnPropertyNames(testFn).filter((name) => {
        ...
        Object.defineProperty(ctx, name,
          {
            get: function chainableMethodGetter() {
              ...
              // Otherwise, redefine all properties (slow!)
                ...
                asserterNames.forEach((asserterName) => {
   ...
   */
      ...
      module.exports = function getOwnEnumerablePropertySymbols(obj) {
        ...
        return Object.getOwnPropertySymbols(obj).filter((sym) => Object.getOwnPropertyDescriptor(obj, sym).enumerable);
      };
    }, {}],
   ...
   */
      ...
      './addChainableMethod': 9, './addLengthGuard': 10, './addMethod': 11, './addProperty': 12, './compareByInspect': 13, './expectTypes': 14, './flag': 15, './getActual': 16, './getMessage': 18, './getOwnEnumerableProperties': 19, './getOwnEnumerablePropertySymbols': 20, './inspect': 23, './isNaN': 24, './isProxyEnabled': 25, './objDisplay': 26, './overwriteChainableMethod': 27, './overwriteMethod': 28, './overwriteProperty': 29, './proxify': 30, './test': 31, './transferFlags': 32, 'check-error': 34, 'deep-eql': 35, 'get-func-name': 36, pathval: 37, 'type-detect': 38,
    }],
    23: [function (require, module, exports) {
      // This is (almost) directly from Node.js utils
      // https://github.com/joyent/node/blob/f8c335d0caf47f16d31413f89aa28eda3878e3aa/lib/util.js

      const getName = require('get-func-name');
   ...
   */
      ...
      function reduceToSingleString(output, base, braces) {
        const length = output.reduce((prev, cur) => prev + cur.length + 1, 0);
   ...
   */
      ...
      function compatibleConstructor(thrown, errorLike) {
        ...
        } if (errorLike.prototype instanceof Error || errorLike === Error) {
   ...
   */
      ...
      const functionNameMatch = /\s*function(?:\s|\s*\/\*[^(?:*\/)]+\*\/\s*)*([^\(\/]+)/;
      function getFunctionName(constructorFn) {
        let name = '';
        if (typeof constructorFn.name === 'undefined') {
          // Here we run a polyfill if constructorFn.name is not defined
          const match = String(constructorFn).match(functionNameMatch);
          if (match) {
            name = match[1];
          }
        } else {
  ...
  */
   ...
   */
      ...
      function objectEqual(leftHandOperand, rightHandOperand, options) {
        const leftHandKeys = getEnumerableKeys(leftHandOperand);
        const rightHandKeys = getEnumerableKeys(rightHandOperand);
